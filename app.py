...
<head>
  ...
  <style>
    ...
    .msg { margin: 5px 0; padding: 8px 12px;
...
<body>
  ...
  <div id="chat-window">
    ...
    <div id="messages"></div>
    <div id="input-area">
      <input id="userInput" type="text" placeholder="Schreibe eine Nachricht…" />
  ...
  <script>
    ...
    function showWelcomeMessage() {
      addMsg("bot", "Hallo 👋! Ich bin dein FS-Chatbot. Stell mir gerne eine Frage.");
    }
    ...
    async function sendMessage(){
      ...
      try{
        // ⚠️ Hier die öffentliche Render-URL einfügen!
        const res = await fetch("https://DEINE-RENDER-URL.onrender.com/chat", {
          method: "POST",
        ...
        removeMsg(typingId);
        addMsg("bot", data.answer || "(keine Antwort)");
      }catch(e){
        removeMsg(typingId);
        addMsg("bot", "Fehler: Server nicht erreichbar.");
        console.error(e);
      }
    }
